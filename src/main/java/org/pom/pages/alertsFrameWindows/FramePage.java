...
public class FramePage extends BasePage {
    ...
    public FramePage returnListOfFrames() {
        ...
        //если страница не работает из-за перекрытых окон
        JavascriptExecutor js = (JavascriptExecutor) driver;//когда элемент перекрыт рекламой или другим объектом и его не видно
        Integer numberOFFrames = Integer.parseInt(js.executeScript("return window.length")
                .toString());
        System.out.println("The total numbers of iframes: " + numberOFFrames);
    ...
    public FramePage switchToIframeByIndex(int index) {
        ...
        driver.switchTo().frame(index);//перепрышиваем во фрейм
